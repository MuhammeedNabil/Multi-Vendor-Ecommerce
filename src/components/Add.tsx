...
const Add = ({
  ...
  const hasSroductOptions = productOptions.length > 0;
  const enableAddBtn = hasSroductOptions && !isSelected;
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex justify-between">
        <div className="flex items-center gap-4">
          {stockNumber < 1 ? (
            <div className="text-s text-orange-500">
        ...
        <button
          ...
          disabled={stockNumber === 0 || enableAddBtn}
